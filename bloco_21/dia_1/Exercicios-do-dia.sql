-- link para o db https://s3.us-east-2.amazonaws.com/assets.app.betrybe.com/back-end/sql/hr-cebf8bc2a5bb252bc470ae28943604c6.sql
...
SELECT DEPARTMENT_ID, AVG(SALARY) as avg, COUNT(*) as count
FROM employees
